...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.report-header','data' => ['title' => 'Supplier List','module' => 'Inventory','submodule' => 'Supplier Management','description' => 'Manage your suppliers, track contact information, and view stock-in history.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Supplier List','module' => 'Inventory','submodule' => 'Supplier Management','description' => 'Manage your suppliers, track contact information, and view stock-in history.']); ?>
      ...
      <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-6 mb-6 lg:mb-8">
        <div class="bg-surface-container-lowest p-4 lg:p-6 rounded-xl shadow-[0_12px_32px_rgba(0,26,64,0.04)] flex flex-col">
          ...
          <div class="flex items-baseline gap-2">
            <span class="text-lg lg:text-2xl font-extrabold text-blue-900 font-headline"><?php echo e($suppliers->count()); ?></span>
          </div>
        </div>
      </div>
                ...
                <tr class="hover:bg-blue-50/30 transition-colors group">
                  <td class="px-3 lg:px-6 py-3 lg:py-5">
                    <div class="flex items-center gap-3 lg:gap-4">
                      ...
                      <div>
                        <div class="text-xs lg:text-sm font-bold text-on-surface"><?php echo e($supplier->name); ?></div>
                        <?php if($supplier->address): ?>
                          <div class="text-[10px] lg:text-[11px] text-slate-400 font-medium truncate max-w-xs"><?php echo e($supplier->address); ?></div>
                        <?php endif; ?>
                      </div>
                    </div>
                  </td>
                  <td class="px-3 lg:px-6 py-3 lg:py-5 hidden md:table-cell">
                    <span class="text-xs lg:text-sm font-medium text-on-surface"><?php echo e($supplier->contact_name ?? '-'); ?></span>
                  </td>
                  <td class="px-3 lg:px-6 py-3 lg:py-5 hidden md:table-cell">
                    <span class="text-xs lg:text-sm font-medium text-on-surface"><?php echo e($supplier->phone ?? '-'); ?></span>
                  </td>
                  <td class="px-3 lg:px-6 py-3 lg:py-5 hidden lg:table-cell">
                    <span class="text-xs lg:text-sm font-medium text-on-surface"><?php echo e($supplier->email ?? '-'); ?></span>
                  </td>
                  <td class="px-3 lg:px-6 py-3 lg:py-5 text-right">
                    <div class="flex items-center justify-end gap-1">
                      <button onclick="openEditModal(<?php echo e($supplier->id); ?>, '<?php echo e(addslashes($supplier->name)); ?>', '<?php echo e(addslashes($supplier->contact_name ?? '')); ?>', '<?php echo e(addslashes($supplier->phone ?? '')); ?>', '<?php echo e(addslashes($supplier->email ?? '')); ?>', '<?php echo e(addslashes($supplier->address ?? '')); ?>')"
                      ...
                      <button onclick="confirmDelete(<?php echo e($supplier->id); ?>, '<?php echo e(addslashes($supplier->name)); ?>')"
...
<?php endif; ?>
<?php /**PATH H:\project\LARAVEL\POS\POS-app\resources\views/pages/supplier.blade.php ENDPATH**/ ?>