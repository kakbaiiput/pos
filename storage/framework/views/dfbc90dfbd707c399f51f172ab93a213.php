                    ...
                    <div
                            ...
                            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-start text-xs sm:text-sm">
                                    <div class="min-w-0 flex-1 mr-2">
                                        <h4 class="font-bold text-on-surface truncate"><?php echo e($item['name']); ?></h4>
                                    ...
                                    <span
                                        class="font-bold text-on-surface text-xs sm:text-sm whitespace-nowrap">Rp<?php echo e(number_format($item['price'] * $item['quantity'], 0, ',', '.')); ?></span>
                                </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-on-surface"><?php echo e($total_qty); ?> items</span>
                            </div>
                            ...
                            <?php if($promo_discount > 0): ?>
                                <div class="flex justify-between text-green-600 font-bold">
                                    ...
                                    <span
                                        class="whitespace-nowrap">-Rp<?php echo e(number_format($promo_discount, 0, ',', '.')); ?></span>
                                </div>
                            <?php endif; ?>

                            <?php if($tier_discount > 0): ?>
                                <div class="flex justify-between text-indigo-600 font-bold">
                                    <span class="truncate mr-2">Member Discount (<?php echo e(ucfirst($customer->tier)); ?>)</span>
                                    <span
                                        class="whitespace-nowrap">-Rp<?php echo e(number_format($tier_discount, 0, ',', '.')); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="flex justify-between" x-show="tax > 0" x-cloak>
                                ...
                                <span class="font-bold text-on-surface">Rp<?php echo e(number_format($tax, 0, ',', '.')); ?></span>
                            </div>
                            ...
                            <?php if($customer): ?>
                                <div class="flex justify-between text-yellow-600 text-[10px] sm:text-xs mt-2"
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <?php if($customer->tier_multiplier > 1): ?>
                                            <span class="text-[8px] sm:text-[9px] opacity-70">(<?php echo e($customer->tier_multiplier); ?>x
                                                <?php echo e(ucfirst($customer->tier)); ?> Multiplier)</span>
                                        <?php endif; ?>
                                    </div>
                                    <span class="font-bold"
                                        x-text="Math.floor((totalDue / <?php echo e($loyalty_points_per_rupiah); ?>) * <?php echo e($customer->tier_multiplier ?? 1); ?>).toLocaleString('id-ID') + ' pts'"></span>
                                </div>
                            <?php endif; ?>
                            <div
                ...
                <div class="col-span-12 lg:col-span-4 flex flex-col gap-4 sm:gap-6">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span><?php echo e(count($cart)); ?> items in cart</span>
                        </div>
                    </div>
                    <!-- Payment Methods -->
                    <div
                    ...
                    <div
                        ...
                        <?php if($availableVouchers->count() > 0): ?>
                            <div class="mb-3 p-3 bg-primary/5 rounded-lg border border-primary/20">
                                ...
                                <div class="space-y-1">
                                    <?php $__currentLoopData = $availableVouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $av): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex justify-between items-center text-xs">
                                            <span class="font-mono font-bold text-on-surface"><?php echo e($av->code); ?></span>
                                            <span class="text-on-surface-variant">
                                                <?php if($av->discount_nominal): ?>
                                                    Rp<?php echo e(number_format($av->discount_nominal, 0, ',', '.')); ?>

                                                <?php elseif($av->discount_percentage): ?>
                                                    <?php echo e($av->discount_percentage); ?>%
                                                <?php endif; ?>
                                            </span>
                                            <?php if($av->min_purchase_amount): ?>
                                                <span class="text-[10px] text-slate-400">Min:
                                                    Rp<?php echo e(number_format($av->min_purchase_amount, 0, ',', '.')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                    ...
                    <?php if($customer): ?>
                        <div class="bg-yellow-50 rounded-xl p-4 sm:p-6 shadow-sm border border-yellow-200">
                            ...
                            <div class="flex items-center justify-between text-xs sm:text-sm mb-3">
                                ...
                                <span class="font-bold text-yellow-800"><?php echo e(number_format($customer->available_points)); ?>

                                    pts</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <input type="number" x-model="pointsToRedeem" min="0"
                                    max="<?php echo e($customer->available_points); ?>"
                                ...
                                <button type="button" @click="applyPoints()"
                                    :disabled="pointsToRedeem < <?php echo e($loyalty_min_redeem); ?>"
                            ...
                            <p class="text-[10px] sm:text-xs text-yellow-600 mt-2">
                                1 point = Rp<?php echo e(number_format($loyalty_point_value, 0, ',', '.')); ?> discount
                            </p>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('paymentCheckout', () => ({
                ...
                pointsDiscount: 0,
                pointsRedeemed: 0,
                loyaltyPointValue: <?php echo e($loyalty_point_value); ?>,
                loyaltyMinRedeem: <?php echo e($loyalty_min_redeem); ?>,
                ...
                formatCurrency(amount) {
                    return new Intl.NumberFormat('<?php echo e($currency_code); ?>', { style: 'currency', currency: 'IDR' }).format(amount);
                },
                ...
                async checkVoucher() {
                    ...
                    try {
                        ...
                        if (data.valid) {
                            ...
                            this.totalDue = Math.max(0, <?php echo e($total); ?> - data.discount - this.pointsDiscount);
                ...
                removeVoucher() {
                    ...
                    this.voucherMessage = '';
                    this.totalDue = Math.max(0, <?php echo e($total); ?> - this.pointsDiscount);
                    if (this.method === 'qris') { this.received = this.totalDue; this.receivedInput = new Intl.NumberFormat('id-ID').format(this.totalDue); }
                },
                ...
                applyPoints() {
                    ...
                    this.pointsRedeemed = Math.min(this.pointsToRedeem, <?php echo e($customer ? $customer->available_points : 0); ?>);
                    this.pointsDiscount = this.pointsRedeemed * this.loyaltyPointValue;
                    this.pointsApplied = true;
                    this.totalDue = Math.max(0, <?php echo e($total); ?> - this.voucherDiscount - this.pointsDiscount);
                    if (this.method === 'qris') { this.received = this.totalDue; this.receivedInput = new Intl.NumberFormat('id-ID').format(this.totalDue); }
                },
                ...
                removePoints() {
                    ...
                    this.totalDue = Math.max(0, <?php echo e($total); ?> - this.voucherDiscount);
                    if (this.method === 'qris') { this.received = this.totalDue; this.receivedInput = new Intl.NumberFormat('id-ID').format(this.totalDue); }
                },
...
<?php endif; ?><?php /**PATH H:\project\LARAVEL\POS\POS-app\resources\views/pages/payment.blade.php ENDPATH**/ ?>