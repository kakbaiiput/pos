...
<?php $component->withAttributes([]); ?>
    ...
    <?php if(isset($pendingCart) && !empty($pendingCart)): ?>
        <script>localStorage.setItem('pos_cart', JSON.stringify(<?php echo json_encode($pendingCart); ?>));</script>
    <?php endif; ?>

    <script>
        const allProducts = <?php echo json_encode($products->map(function ($p) {
    return [
        'id' => $p->id,
        'name' => $p->name,
        'sku' => $p->sku,
        ...
        const allPromotions = <?php echo json_encode($promotions->map(function ($p) {
    return [
        'id' => $p->id,
        'name' => $p->name,
        'type' => $p->type,
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('posCart', () => ({
                ...
                currencyCode: '<?php echo e($currency); ?>',
                serviceRate: <?php echo e($service_charge); ?>,
...
<?php endif; ?><?php /**PATH H:\project\LARAVEL\POS\POS-app\resources\views/pages/home.blade.php ENDPATH**/ ?>